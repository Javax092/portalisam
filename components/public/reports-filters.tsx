  ...
  return (
    <FilterBar>
      <form className="grid gap-3 xl:grid-cols-[1.15fr_1fr_1fr_1fr_1fr_auto]">
        <Input defaultValue={query} name="query" placeholder="Buscar por titulo, descricao ou local" />
        ...
        <Input defaultValue={neighborhood} name="neighborhood" placeholder="Filtrar por bairro" />
