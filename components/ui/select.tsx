  ...
  ({ className, children, error, helperText, id, label, ...props }, ref) => {
    const select = (
      <select
        ...
        className={cn(
          "premium-focus flex min-h-12 w-full rounded-2xl border border-slate-300 bg-white px-4 py-3.5 text-base text-slate-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.65),0_1px_2px_rgba(15,23,42,0.05)] outline-none transition duration-200 hover:border-slate-400 focus:border-sky-500 focus:bg-white disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-500 sm:h-12 sm:py-3 sm:text-sm",
